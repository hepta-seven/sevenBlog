...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="/sevenBlog/Public/Admin/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- Font Awesome -->
    <link href="/sevenBlog/Public/Admin/css/font-awesome.min.css" rel="stylesheet">

    <!-- ionicons -->
    <link href="/sevenBlog/Public/Admin/css/ionicons.min.css" rel="stylesheet">

    <!-- Morris -->
    <link href="/sevenBlog/Public/Admin/css/morris.css" rel="stylesheet"/>

    <!-- Datepicker -->
    <link href="/sevenBlog/Public/Admin/css/datepicker.css" rel="stylesheet"/>

    <!-- Animate -->
    <link href="/sevenBlog/Public/Admin/css/animate.min.css" rel="stylesheet">

    <!-- Owl Carousel -->
    <link href="/sevenBlog/Public/Admin/css/owl.carousel.min.css" rel="stylesheet">
    <link href="/sevenBlog/Public/Admin/css/owl.theme.default.min.css" rel="stylesheet">

    <!-- Simplify -->
    <link href="/sevenBlog/Public/Admin/css/simplify.min.css" rel="stylesheet">
        ...
        <div class="sidebar-inner scrollable-sidebar">
                ...
                <ul class="sidebar-list">
                    <li>
                        <a href="#" class="clearfix">
                            <img src="/sevenBlog/Public/Admin/images/profile/profile2.jpg" class="img-circle"
                                 alt="user avatar">
                    ...
                    <li>
                        <a href="#" class="clearfix">
                            <img src="/sevenBlog/Public/Admin/images/profile/profile3.jpg" class="img-circle"
                                 alt="user avatar">
                            <div class="chat-detail m-left-sm">
                                <div class="chat-name">
                                    Jane Doe
                    ...
                    <li>
                        <a href="#" class="clearfix">
                            <img src="/sevenBlog/Public/Admin/images/profile/profile4.jpg" class="img-circle"
                                 alt="user avatar">
                            <div class="chat-detail m-left-sm">
                                <div class="chat-name">
                                    John Doe
                    ...
                    <li>
                        <a href="#" class="clearfix">
                            <img src="/sevenBlog/Public/Admin/images/profile/profile5.jpg" class="img-circle"
                                 alt="user avatar">
                            <div class="chat-detail m-left-sm">
                                <div class="chat-name">
                                    John Doe
            ...
            <div class="content-block">
                <ul class="sidebar-list">
                    <li>
                        <a href="#" class="clearfix">
                            <img src="/sevenBlog/Public/Admin/images/profile/profile6.jpg" class="img-circle"
                                 alt="user avatar">
                            <div class="chat-detail m-left-sm">
                                <div class="chat-name">
                                    John Doe
                    ...
                    <li>
                        <a href="#" class="clearfix">
                            <img src="/sevenBlog/Public/Admin/images/profile/profile7.jpg" class="img-circle"
                                 alt="user avatar">
                            <div class="chat-detail m-left-sm">
                                <div class="chat-name">
                                    Jane Doe
                    ...
                    <li>
                        <a href="#" class="clearfix">
                            <img src="/sevenBlog/Public/Admin/images/profile/profile8.jpg" class="img-circle"
                                 alt="user avatar">
                            <div class="chat-detail m-left-sm">
                                <div class="chat-name">
                                    John Doe
                    ...
                    <li>
                        <a href="#" class="clearfix">
                            <img src="/sevenBlog/Public/Admin/images/profile/profile9.jpg" class="img-circle"
                                 alt="user avatar">
                            <div class="chat-detail m-left-sm">
                                <div class="chat-name">
                                    John Doe
                    ...
                    <li>
                        ...
                        <ul class="dropdown-menu dropdown-sm pull-right user-dropdown">
                            <li class="user-avatar">
                                <img src="/sevenBlog/Public/Admin/images/profile/profile1.jpg" alt="" class="img-circle">
                ...
                <div class="pull-right m-right-sm">
                    <div class="user-block hidden-xs">
                        <a href="#" id="userToggle" data-toggle="dropdown">
                            <img src="/sevenBlog/Public/Admin/images/profile/profile1.jpg" alt=""
                            ...
                            <ul class="dropdown-menu message pull-right">
                                ...
                                <li>
                                    <a class="clearfix" href="#">
                                        <img src="/sevenBlog/Public/Admin/images/profile/profile2.jpg" alt="User Avatar">
                                        <div class="detail">
                                ...
                                <li>
                                    <a class="clearfix" href="#">
                                        <img src="/sevenBlog/Public/Admin/images/profile/profile3.jpg" alt="User Avatar">
                                        <div class="detail">
                                ...
                                <li>
                                    <a class="clearfix" href="#">
                                        <img src="/sevenBlog/Public/Admin/images/profile/profile4.jpg" alt="User Avatar">
                                ...
                                <li>
                                    <a class="clearfix" href="#">
                                        <img src="/sevenBlog/Public/Admin/images/profile/profile5.jpg" alt="User Avatar">
                                        <div class="detail">
                                            ...
                                            <ul class="chat">
                                                <li class="left clearfix">
															<span class="chat-img pull-left">
																<img src="/sevenBlog/Public/Admin/images/profile/profile2.jpg"
                                                                     alt="User Avatar">
															</span>
                                                    <div class="chat-body clearfix">
                                                        <div class="header">
                                                            ...
                                                            <small class="pull-right text-muted"><i
                                                                    class="fa fa-clock-o"></i> 12 mins ago
                                                            </small>
                                                        </div>
                                                        <p>
                                                ...
                                                <li class="right clearfix">
															<span class="chat-img pull-right">
																<img src="/sevenBlog/Public/Admin/images/profile/profile3.jpg"
                                                                     alt="User Avatar">
															</span>
                                                    <div class="chat-body clearfix">
                                                        <div class="header">
                                                            ...
                                                            <small class="pull-right text-muted"><i
                                                                    class="fa fa-clock-o"></i> 13 mins ago
                                                            </small>
                                                        </div>
                                                        <p>
                                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                ...
                                                <li class="left clearfix">
                                                    ...
                                                    <div class="chat-body clearfix">
                                                        <div class="header">
                                                            <strong class="primary-font">John Doe</strong>
                                                            <small class="pull-right text-muted"><i
                                                                    class="fa fa-clock-o"></i> 20 mins ago
                                                            </small>
                                                        </div>
                                                        <p>
                                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                ...
                                                <li class="right clearfix">
                                                    ...
                                                    <div class="chat-body clearfix">
                                                        <div class="header">
                                                            <strong class="primary-font">Jane Doe</strong>
                                                            <small class="pull-right text-muted"><i
                                                                    class="fa fa-clock-o"></i> 25 mins ago
                                                            </small>
                                                        </div>
                                                        <p>
                                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
...
<!-- Jquery -->
<script src="/sevenBlog/Public/Admin/js/jquery-1.11.1.min.js"></script>

<!-- Bootstrap -->
<script src="/sevenBlog/Public/Admin/bootstrap/js/bootstrap.min.js"></script>

<!-- Flot -->
<script src='/sevenBlog/Public/Admin/js/jquery.flot.min.js'></script>

<!-- Slimscroll -->
<script src='/sevenBlog/Public/Admin/js/jquery.slimscroll.min.js'></script>

<!-- Morris -->
<script src='/sevenBlog/Public/Admin/js/rapheal.min.js'></script>
<script src='/sevenBlog/Public/Admin/js/morris.min.js'></script>

<!-- Datepicker -->
<script src='/sevenBlog/Public/Admin/js/uncompressed/datepicker.js'></script>

<!-- Sparkline -->
<script src='/sevenBlog/Public/Admin/js/sparkline.min.js'></script>

<!-- Skycons -->
<script src='/sevenBlog/Public/Admin/js/uncompressed/skycons.js'></script>

<!-- Popup Overlay -->
<script src='/sevenBlog/Public/Admin/js/jquery.popupoverlay.min.js'></script>

<!-- Easy Pie Chart -->
<script src='/sevenBlog/Public/Admin/js/jquery.easypiechart.min.js'></script>

<!-- Sortable -->
<script src='/sevenBlog/Public/Admin/js/uncompressed/jquery.sortable.js'></script>

<!-- Owl Carousel -->
<script src='/sevenBlog/Public/Admin/js/owl.carousel.min.js'></script>

<!-- Modernizr -->
<script src='/sevenBlog/Public/Admin/js/modernizr.min.js'></script>

<!-- Simplify -->
<script src="/sevenBlog/Public/Admin/js/simplify/simplify.js"></script>
<script src="/sevenBlog/Public/Admin/js/simplify/simplify_dashboard.js"></script>
